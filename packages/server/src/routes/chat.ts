...
import { Mode, MessageStatus } from "@darkcode/database/enums";
import { type ChatStreamEvent } from "@darkcode/shared";
...
// strip error messages and empty assistant messages from convo
